...
#define STRING_CONFIG_H_AUTHOR "Butcher Orc v1.0" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Orc 3 Pro"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ender 3 v2
    ...
    // >> M303 E0 C10 S200 U1 (extruder 0 cycles 10 temp 200 save to ram)
    // >> M500 (save to eeprom)
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //#define DEFAULT_bedKd 624.59
    // >> M303 E-1 C10 S60 U1 (bed -1 cycles 10 temp 60 save to ram)
    // >> M500 (save to eeprom)
    // https://marlinfw.org/docs/gcode/M303.html
  #define DEFAULT_bedKp 195.84
  #define DEFAULT_bedKi 37.09
  #define DEFAULT_bedKd 689.37
...
#define CLASSIC_JERK
  ...
  #define DEFAULT_XJERK  7.2
  #define DEFAULT_YJERK  7.2
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -0.1 }  // probing 0.1mm above bed for manual mesh leveling
